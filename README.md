...
* You will be give a set of poll data called [election_data.csv](https://drive.google.com/open?id=1-9n_Ozz3m7b-piEBYkr1G-0Yx9q_NWIx). The dataset is composed of three columns: `Voter ID`, `County`, and `Candidate`. Your task is to create a Python script that analyzes the votes and calculates each of the following:
